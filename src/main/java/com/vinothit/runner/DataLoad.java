...
public class DataLoad implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
      ...
      // Adding Gender Types into Database
		/*
		 * Gender gendertype1=new Gender(); gendertype1.setGenderType("Male");
		 * 
		 * Gender gendertype2=new Gender(); gendertype2.setGenderType("Fe-Male");
		 * 
		 ...
		 * 
		 * System.out.println("Gender Data :: "+ allGendersInsertionStatus +
		 * " loaded successfully");
		 */
      ...
      //Adding Course Types into Database
		/*
		 * Course course1=new Course(); course1.setCourseName("Spring");
		 * 
		 * Course course2=new Course(); course2.setCourseName("Hibernate");
		 * 
		 * Course course3=new Course(); course3.setCourseName("SpringBoot");
		 * 
		 * Course course4=new Course(); course4.setCourseName("AWS");
		 * 
		 * Course course5=new Course(); course5.setCourseName("DevOps");
		 * 
		 * List<Course> allCourses =
		 * Arrays.asList(course1,course2,course3,course4,course5);
		 * 
		 * List<Course> allCoursesInsertionStatus = courseRepo.saveAll(allCourses);
		 * 
		 * System.out.println("Courses Data :: "+ allCoursesInsertionStatus +
		 * " loaded successfully");
		 */
      ...
      //Adding Timings into Database
		/*
		 * Timings timing1=new Timings(); timing1.setTimingsName("Morning");
		 * 
		 * Timings timing2=new Timings(); timing2.setTimingsName("Noon");
		 * 
		 * Timings timing3=new Timings(); timing3.setTimingsName("Evening");
		 * 
		 ...
		 * 
		 * System.out.println("timings Data :: "+ alltimingsInstertionStatus +
		 * " loaded successfully");
		 */
